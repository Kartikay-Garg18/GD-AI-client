...
const MeetingCardComponent = () => {
  return (
    <div className='w-full rounded-lg bg-white p-3 md:p-4 flex flex-col gap-3 md:gap-4 transition-all duration-300 ease-in-out hover:scale-100 hover:bg-white/30 hover:shadow-lg hover:-translate-y-0.5'>
        <>
        <div className='truncate font-semibold text-base md:text-lg text-[#1b263b]'>Discussion with Google about the new</div>
        <div className='flex justify-end gap-1 px-1 items-center'><span className="text-sm md:text-base">9:00</span><span className='text-gray-600 text-xs md:text-sm'>AM</span></div>
        </>
        <div className='flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 sm:gap-0'>
            <div className='text-xs md:text-sm'><span className='text-gray-600'>Host: </span><span className='text-[#1b263b]'>Anjali Mehra</span></div>
