...
const CreateCardComponent = ({handleCreateOpen}) => {
  return (
    <div onClick={handleCreateOpen} className='cursor-pointer w-full md:w-9/20 bg-white rounded-lg p-2 sm:p-3 md:p-4 flex flex-col gap-2 sm:gap-4 md:gap-6 transition-all duration-300 ease-in-out hover:scale-100 hover:bg-white/30 hover:shadow-lg hover:-translate-y-0.5'>
...
const CreateCard = React.memo(CreateCardComponent, () => true);
